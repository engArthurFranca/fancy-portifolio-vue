...
<template>
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-10 md:justify-center md:text-center bg-inherit  dark:text-white">
        <div class="text-left w-full md:w-1/2">
            ...
            <p class="text-base mt-4">
                I am excited about finding my first opportunity to contribute to a company's success and am confident that my technical skills and passion for learning will make me a valuable asset to any team. Let's work together to make great things happen!
            </p>
            <p class="text-base mt-4">
                Looking for a skilled and ambitious software engineer who is eager to join your team? Look no further!
            </p>
            ...
            <div class="mt-4 pl-2">
                ...
                <a href="https://github.com/engArthurFranca" target="_blank" class="text-black border border-transparent
                w-12  hover:border-blue-700 hover:text-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg p-1 text-center inline-flex items-center me-2
                dark:text-white dark:hover:text-blue-500 dark:focus:ring-blue-500 ">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20" version="1.1" class="fill-current">
                ...
                <a href="https://www.instagram.com/arthur._.franca/" target="_blank" class="text-black border border-transparent
                w-12  hover:border-blue-700 hover:text-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg p-1 text-center inline-flex items-center me-2
                dark:text-white dark:hover:text-blue-500 dark:focus:ring-blue-500 ">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20" version="1.1" class="fill-current">
                ...
                <a href="https://www.linkedin.com/in/eng-arthurfranca/" target="_blank" class="text-black border border-transparent
                w-12  hover:border-blue-700 hover:text-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg p-1 text-center inline-flex items-center me-2
                dark:text-white dark:hover:text-blue-500 dark:focus:ring-blue-500 ">
                ...
                <a href="https://www.facebook.com/TatuCafeinado" target="_blank" class="text-black border border-transparent
                w-12  hover:border-blue-700 hover:text-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg p-1 text-center inline-flex items-center me-2
                dark:text-white dark:hover:text-blue-500 dark:focus:ring-blue-500 ">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current">
        ...
        <img class="rounded-full w-min-1/2 md:w-auto mx-auto shadow-md" src="../assets/profile.png">
    </div>
</template>
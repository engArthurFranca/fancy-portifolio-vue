<script setup>
    import useToogle from '../composable/useToogle.js';
    import useToogleTheme from '../composable/useToogleTheme.js';

    const { isActive, toogleElement } = useToogle();

    const { isDark, toogleTheme } = useToogleTheme();
</script>
  ...
  <nav class="bg-white border-gray-200 fixed top-0 w-full dark:bg-gray-700">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <button data-collapse-toggle="navbar-sticky" @click="toogleElement" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-sticky" aria-expanded="false">
      ...
      <div :class="{'hidden': !isActive}">
            <div class="space-y-1 px-2 pb-3 pt-2 text-center rounded-xl shadow-xl ">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
              <a @click="toogleElement" href="#about" class=" text-black hover:bg-blue-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium dark:text-white">About</a>
              <a @click="toogleElement" href="#projects" class="text-black hover:bg-blue-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium dark:text-white">Projects</a>
              <a @click="toogleElement" href="#formation" class="text-black hover:bg-blue-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium dark:text-white">Formation</a>
              <a @click="toogleElement" href="#contact" class="text-black hover:bg-blue-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium dark:text-white">Contact</a>
            </div>
        </div>
    </nav>
</template>
